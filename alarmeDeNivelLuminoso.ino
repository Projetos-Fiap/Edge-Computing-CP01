...
const int ldrPin = A0;   // Pino analógico utilizado para leitura do LDR
const int greenLedPin = 2;   // Pino digital para o LED verde
const int yellowLedPin = 1;   // Pino digital para o LED amarelo
const int redLedPin = 0;   // Pino digital para o LED vermelho
const int buzzerPin = 4;   // Pino digital para o buzzer
